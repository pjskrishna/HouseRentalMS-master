            ...
            else
            {
                ...
                try
                {
                    using (Con)
                    {
                        using (SqlCommand cmd = new SqlCommand(Query))
                        {
                            cmd.Parameters.AddWithValue("@AP", ApartTb.SelectedItem.ToString());
                            cmd.Parameters.AddWithValue("@TE", TenantTb.SelectedItem.ToString());
            ...
            else
            {
                ...
                try
                {
                    using (Con)
                    {
                        using (SqlCommand cmd = new SqlCommand(Query))
                        {
                            cmd.Parameters.AddWithValue("@AP", ApartTb.SelectedIndex.ToString());
                            cmd.Parameters.AddWithValue("@TE", TenantTb.SelectedIndex.ToString());
                            cmd.Parameters.AddWithValue("@PE", PeriodTb.Text);
                            cmd.Parameters.AddWithValue("@AM", AmountTb.Text);
                            cmd.Connection = Con;
                            Con.Open();
